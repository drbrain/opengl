...
# This is the extconf.rb file for creating the glu module.
...
if have_gl_library( gl_libname ) && have_glu_library( glu_libname )
    create_makefile( "glu" )
else
    puts "Error: Couldn't create the makefile for the GLU module."
    exit 1
end
